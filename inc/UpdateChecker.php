...
/**
 * GitHub-basierter Auto-Update-Checker für rh-consent. Zieht das Release-ZIP aus den
 * GitHub Releases (Tags `v*`), inkl. gebundeltem Core und plugin-update-checker.
 */
final class UpdateChecker
{
    public const GITHUB_REPO = 'https://github.com/herbeckrobin/rh-consent/';
    public const PLUGIN_SLUG = 'rh-consent';
